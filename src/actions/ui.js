...
export const UI_INSPECT_CURATION_DATA = 'UI_INSPECT_CURATION_DATA'
 ...
 * @param  {} entity
 */
export function uiInspectCurationData(token, entity, prNumber) {
  return getCurationDataAction(token, entity, UI_INSPECT_CURATION_DATA, prNumber)
}

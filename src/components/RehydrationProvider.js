...
import { App, PageLanding, PageCurate, PageDefinitions, PageDefinitions2, PageInspect, PageHarvest } from './'
        ...
        <Router>
          <App className="App">
            <Switch>
              ...
              <Route path={ROUTE_DEFINITIONS2} component={withTracker(PageDefinitions2)} />
